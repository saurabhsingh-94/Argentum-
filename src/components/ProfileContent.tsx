...
import { Github, Globe, Award, Flame, Zap, Twitter, Edit3, Share2, Calendar, Rocket } from 'lucide-react'
...
export default function ProfileContent({ initialProfile, posts, isOwner }: ProfileContentProps) {
  ...
  useEffect(() => {
    setIsMounted(true)
    // Small timeout to ensure the browser has registered the initial state for transitions
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-silver/30">
      ...
      <div className="relative h-64 md:h-80 w-full overflow-hidden">
        ...
        {/* Animated Glows in Hero - using pure CSS animations defined in globals.css or inline */}
        <div 
            ...
            <div className="flex flex-col items-center lg:items-start gap-6">
              ...
              <div className="flex flex-col gap-6 w-full pt-4 border-t border-white/5">
                ...
                <div 
                    ...
                    style={getAnimationStyle('slideLeft', 300)}
                >
